...
<%
    ...
    List<Map<String, Object>> submit_project = service.findNationSubmitProject(request.getSession().getAttribute("id"));
    List<Map<String, Object>> mid_project = service.findNationMidProject(request.getSession().getAttribute("id"));
    List<Map<String, Object>> res_project = service.findNationResProject(request.getSession().getAttribute("id"));
%>
