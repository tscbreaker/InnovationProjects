...
<%
    ...
    List<Map<String, Object>> submit_project = service.findAcademySubmitProject(request.getSession().getAttribute("id"));
    List<Map<String, Object>> mid_project = service.findAcademyMidProject(request.getSession().getAttribute("id"));
    List<Map<String, Object>> res_project = service.findAcademyResProject(request.getSession().getAttribute("id"));
%>
