...
<%
    ...
    List<Map<String, Object>> submit_project = service.findProvinceSubmitProject(request.getSession().getAttribute("id"));
    List<Map<String, Object>> mid_project = service.findProvinceMidProject(request.getSession().getAttribute("id"));
    List<Map<String, Object>> res_project = service.findProvinceResProject(request.getSession().getAttribute("id"));
%>
