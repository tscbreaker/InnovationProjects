...
<%
    ...
    List<Map<String, Object>> tea_project = service.findResTeaProject(request.getSession().getAttribute("id"));
%>
<table>
    ...
    <%
        for (Map<String, Object> stringObjectMap : tea_project) {
            ...
            out.print("<td><a href='teacher_sug.jsp?p_id="+stringObjectMap.get("p_id")+"'>结题确认</a></td>");
            out.print("</tr>");
        }
        session.setAttribute("operate","res");
    %>
</table>
</body>
</html>
