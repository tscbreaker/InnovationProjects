...
<%
    ...
    List<Map<String, Object>> stu_project = service.findSubmitStuProject(request.getSession().getAttribute("id"));
%>
<table>
    ...
    <%
        for (Map<String, Object> stringObjectMap : stu_project) {
            ...
            out.print("<td><form method=\"post\" action=\"uploadServlet?operate=submit&p_id="+stringObjectMap.get("p_id")+"\" enctype=\"multipart/form-data\">\n" +
