...
<%
    ...
    List<Map<String, Object>> tea_project = service.findSubmitTeaProject(request.getSession().getAttribute("id"));
%>
<table>
    ...
    <%
        for (Map<String, Object> stringObjectMap : tea_project) {
            ...
            out.print("<td><a href='teacher_sug.jsp?p_id="+stringObjectMap.get("p_id")+"'>立项确认</a></td>");
            out.print("</tr>");
        }
        session.setAttribute("operate","submit");
    %>
</table>
</body>
</html>